...
public class EliminarServicio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String txtNombreServElim = request.getParameter("txtNombreServElim");
        String txtUserElimServ = request.getParameter("txtUserElimServ");
        Consultas co = new Consultas();
        if(co.eliminarServicio(txtNombreServElim,txtUserElimServ)){
