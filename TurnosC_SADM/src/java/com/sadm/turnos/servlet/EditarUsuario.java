...
public class EditarUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(co.editarUsuario(txtEditarUId,txtEditarUUsu,txtEditarUNombre,txtEditarUPass,txtEditarUEmail,txtEditarUEPerfil,txtEditarUEstatus,txtEditarUOfi,txtusredit)){
